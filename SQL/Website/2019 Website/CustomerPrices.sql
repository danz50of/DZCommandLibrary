/****************************************************************************
 *                                                                          *
 * SQL File: CustomerPrices.sql                                             *
 * Date:     8/31/2019                                                      *
 *                                                                          *
 ****************************************************************************
 ****************************************************************************
 *                                                                          *
 * Note:  This file will pull current price list pricing for one customer   *
 *        when the account number is replaced in the where clause.          *
 *                                                                          *
 ***************************************************************************/
Select
a.customer_no,
...
where
a.customer_no in ('092245')--in ('422660', '422661','827730','827731','836540','836541','810200','100149') 
and
