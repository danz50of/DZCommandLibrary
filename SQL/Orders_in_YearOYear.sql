...
and ((trunc(a.date_entered,'yy')>=trunc(sysdate,'yy')) AND (trunc(a.date_entered,'mm')<=trunc(sysdate,'mm')) AND (A.CONTRACT='MP') OR (trunc(a.date_entered,'yy')>=trunc(add_months(sysdate,-12),'yy')) AND (trunc(a.date_entered,'mm')<=trunc(add_months(sysdate,-12),'mm')) AND (A.CONTRACT='MP'))
