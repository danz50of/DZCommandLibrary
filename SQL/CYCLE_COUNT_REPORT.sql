...
SELECT PART_NO, DESCRIPTION, COST_PER_UNIT, DEMAND, ABC_CLASS, ACCOUNTING_GROUP, LOCATION_NO, MIN_LAST_COUNT_DATE, ACTUAL_LAST_COUNT_DATE, QTY_ONHAND, DAYS_TO_COUNT, MIN_LAST_COUNT_DATE + DAYS_TO_COUNT AS NEXT_COUNT_DATE, QTY_COUNTED
FROM(
